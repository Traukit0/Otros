...
//El Nº de teléfono debe tener el código del país
const String PHONE = "Ingrese su nº de teléfono";

//GSM Module RX pin a ESP32 2
//GSM Module TX pin a ESP32 4
#define rxPin 4
#define txPin 2
...
void parseData(String buff){
  ...
  if(buff != "OK"){
    ...
    if(cmd == "+CMTI"){
      ...
      extractSms(buff);
      Serial.println("Numero que envía: "+senderNumber);
      Serial.println("Teléfono: "+PHONE);
      if(senderNumber == PHONE){
        if(msg == "Ubicación"){
          sendLocation();
        }
        else if(msg == "Velocidad"){
          sendSpeed();
        }
      }
      sim800.println("AT+CMGD=1,4"); //delete all saved SMS
